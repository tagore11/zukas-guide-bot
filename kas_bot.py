...
ZUKAS_X_PROMPT = (
    ...
    "E) ZuGov / governance research (plurality governance, futarchy, MACI/zk-voting, AI+governance, "
    "epistemik çöküş/Acemoglu knowledge collapse, DAO governance post-mortem, quadratic funding, "
    "commons ekonomisi, Vitalik governance yazıları) — yeni paper/makale/blog sinyali; akademik link değerli, "
    "ZuGov tezine (Grounding Engine, epistemic latency, Synthetic Futarchy) ORGANİK köprü kur\n\n"
    ...
    "━━━ FIRSAT n — [hat: Zu/Localism/Cosmolocalism/Kaş/ZuGov]\n"
